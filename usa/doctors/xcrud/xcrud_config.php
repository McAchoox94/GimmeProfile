<?php /** Configuration file; f0ska xCRUD v.1.6.21; 06/2014 */
...
//    public static $dbname = 'ebay_store'; // Your database name
...
//
    ...
    public static $dbname = 'profile_doctors_usa'; // Your database name

    public static $dbuser = 'etsbelbarakacom'; // Your database username

    public static $dbpass = '@@AchrafBj94!!'; // // Your database password

    public static $dbhost = 'etsbelbarakacom.ipagemysql.com'; // Your database host, 'localhost' is default.
    ...
    public static $limit = 15; // default limit of rows per page
