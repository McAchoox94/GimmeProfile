<?php 
    $location = "etsbelbarakacom.ipagemysql.comt";
    $user = "etsbelbarakacom";
    $pass = "@@AchrafBj94!!";
    $link ='/usa/doctors/searchDocs/';
...
?>                    
                   ...
                   <div class="product-grid-list">
                    ...
                    <?php if ($num !=0) {
                        do { 
                            if($searchres['picture']!="" && $searchres['picture']!=NULL){
                                $picture="images/".$searchres['picture'];
                                $link ='http://localhost/DocsNetwork/';
                                $url = $link.$picture;
                                
                               if ( !is_url_exist($url)) {
                                    $picture="images/products/products-1.jpg";
                                }
...
<div class="product-item bg-light">
	<div class="card">
		...
		<div class="card-body">
		    <h4 class="card-title"><a href="single.html"><?echo $searchres['name']?></a></h4>
		    <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
		    		<a href="single.html"><?echo $searchres['title']?></a>
		    	</li>
		    	<li class="list-inline-item">
		    		<a href="#"><i class="fa fa-calendar"></i><?echo $searchres['date_of_birth']?></a>
		    	</li>
		    </ul>
            <ul class="list-inline product-meta">
		    	<li class="list-inline-item">
                <a href="#"><i class="fa fa-address-card"></i><?echo $searchres['address']?></a>
		    	</li>
		    	<li class="list-inline-item">
		    		<a href="#"><i class="fa fa-phone"></i><?echo $searchres['phone']?></a>
		    	</li>
		    </ul>
