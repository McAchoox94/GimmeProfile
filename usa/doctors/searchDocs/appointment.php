...
<?php 
    ...
    $reponse = $bdd->query('SELECT * FROM `profile` WHERE id='.$id); 
    $searchres = $reponse->fetch(); 
		...
		<div class="row">
			<div class="col-md-10 offset-md-1 col-lg-3 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget user">
						...
						<!-- User Name -->
						<h5 class="text-center"><?echo $searchres['about']?></h5>
					</div>
					<!-- Dashboard Links -->
					<div class="widget dashboard-links">
						<ul>
							<li><a class="my-1 d-inline-block" href="">Speciality</a></li>
							<li><a class="my-1 d-inline-block" href="">phone <span>(5)</span></a></li>
							
							<li><a class="my-1 d-inline-block" href="">Addresse</a></li>
						</ul>
					</div>
				</div>
			</div>
			<div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<!-- Change Password -->
					<div class="widget addresse">
						<h3 class="widget-header user">Addresse</h3>
						<form action="#">
							<!-- Current Password -->
							<div class="form-group">
								<label for="current-addresse">Current Addresse</label>
								<input type="addresse" class="form-control" id="current-addresse">
							</div>
							<!-- New Password -->
                            <div class="form-group">
